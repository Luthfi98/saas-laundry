...
<div class="nav-header">
    <a href="{{ route('dashboard.index') }}" class="brand-logo">
        <img src="{{ url($setting->logo) }}" class="logo-abbr" width="32" height="30" alt="">
        ...
        <span style="font-size: 12px" class="brand-title text-white">{{ $setting->name }}</span>
                        ...
                        <ul class="contacts">
                            ...
                            <li class="active dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('cms/images/avatar/1.jpg') }}" class="rounded-circle user_img" alt="">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('cms/images/avatar/2.jpg') }}" class="rounded-circle user_img" alt="">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('cms/images/avatar/3.jpg') }}" class="rounded-circle user_img" alt="">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('cms/images/avatar/4.jpg') }}" class="rounded-circle user_img" alt="">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('cms/images/avatar/5.jpg') }}" class="rounded-circle user_img" alt="">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                    ...
                    <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                                <img src="{{ asset('cms/images/avatar/1.jpg') }}" class="rounded-circle user_img_msg" alt="">
                            </div>
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            ...
                            <div class="img_cont_msg">
                        <img src="{{ asset('cms/images/avatar/2.jpg') }}" class="rounded-circle user_img_msg" alt="">
                            </div>
                        </div>
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown notification_dropdown">
                            @php
                                ...
                                $hideLight = '';
                                $hideDark = '';
                                if (Auth::user()->theme_version == 'dark') {
                                    $active = 'active';
                                    $hideDark = 'hidden';
                                }else{
                                    $hideLight = 'hidden';
                            ...
                            <a class="nav-link bell dz-theme-mode {{ $active }}" href="javascript:void(0);">
                                <svg id="icon-light" {{ $hideLight }} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                ...
                                <svg id="icon-dark" {{ $hideDark }} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                <div class="media me-2">
                                                    <img alt="image" width="50" src="{{ asset('cms/images/avatar/1.jpg') }}">
                                                </div>
                                ...
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="header-info2 d-flex align-items-center">
                                        <div class="header-media">
                                            <img src="{{ Auth::user()->image ? url(Auth::user()->image) :  asset('cms/images/user.jpg') }}" alt="">
                                        </div>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end" style="">
                                    <div class="card border-0 mb-0">
                                        <div class="card-header py-2">
                                            <div class="products">
                                                <img src="{{ Auth::user()->image ? url(Auth::user()->image) :  asset('cms/images/user.jpg') }}" class="avatar avatar-md" alt="">
                                                <div>
