    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('tenant.branch.update', ['code' => request()->route('code'), 'id' => $branch->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group mt-3 row">
                            <label for="code" class="col-sm-2 col-form-label">Branch Code</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-switch">
                                    <input class="form-check-input @error('is_active') is-invalid @enderror" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $branch->is_active) == '1' ? 'checked' : '' }}>
