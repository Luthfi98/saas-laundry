    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('tenant.services.update', ['code' => request()->route('code'), 'service' => $service->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price', $service->price) }}" required min="0" step="0.01">
                                @error('price')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('unit') is-invalid @enderror" id="unit" name="unit" value="{{ old('unit', $service->unit) }}" required>
                                @error('unit')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-switch">
                                    <input class="form-check-input @error('is_active') is-invalid @enderror" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $service->is_active) == '1' ? 'checked' : '' }}>
