    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('tenant.transactions.store', ['code' => request()->route('code')]) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('total') is-invalid @enderror" id="total" name="total" value="{{ old('total') }}" required min="0" step="0.01">
                                @error('total')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
